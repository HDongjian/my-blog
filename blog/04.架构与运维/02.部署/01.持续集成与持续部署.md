---
title: 持续集成与持续部署
date: 2021-02-23 16:03:31
permalink: /pages/fd3534/
categories:
tags:
  - 
---
...
![img](/deploy/f96f19e4d567aad5006d841963a86e41_hd.jpg)
...
![img](/deploy/image-20190611100501785.png)

CirCle CI的价格：

![img](/deploy/image-20190611100534676.png)
...
![img](/deploy/image-20190611103941326.png)
...
![img](/deploy/image-20190611163108298.png)

Jenkins的界面

![img](/deploy/image-20190611163727975.png)

任务详情页面

![img](/deploy/image-20190611163855257.png)
...
4. 配置Jenkins插件加速
   ...
   ![img](/deploy/70-20190611152837311.png)
...
![img](/deploy/image-20190612205411602.png)

这里第二步在，`Dashboard`这个选项卡中，点击`Activate`这个按钮

![img](/deploy/image-20190612212459194.png)

完了之后，Dashboard会列出所有Github中有`.travis.yml`配置文件的仓库：

![img](/deploy/image-20190612212731186.png)

Travis 会列出 Github 上面你的所有仓库，以及你所属于的组织。此时，选择你需要 Travis 帮你构建的仓库，打开仓库旁边的开关。一旦激活了一个仓库，Travis 会监听这个仓库的所有变化。

![img](/deploy/image-20190612213022380.png)

- `Settings`中用于配置项目的构建条件

  ![img](/deploy/image-20190612214434173.png)

- `Requests`可以查看构建记录

  ![img](/deploy/image-20190612214519926.png)
...
![img](/deploy/image-20190612225000955.png)
...
1. 注册 CircleCI
   ...
   ![img](/deploy/image-20190613093550553.png)

   进行授权：

   ![img](/deploy/image-20190613093732415.png)

2. 启动存储库

检查要在 CircleCI 上管理的存储库的开关按钮。

![img](/deploy/image-20190613094115350.png)
...
4. 设置/查看任务
   ...
   ![img](/deploy/image-20190613093327981.png)
